<meta http-equiv="refresh" content="0; url='https://mimbcd-ui.github.io/dataset-uta10-annotations/web/index.html'" />

# UTA10: Annotations Files Dataset

<img src="https://github.com/MIMBCD-UI/meta/blob/master/banners/datasets_1280x640.png?raw=true" width="100%" />

[![License: AGPL v3](https://img.shields.io/badge/License-AGPL%20v3-blue.svg?style=flat-square)](https://github.com/MIMBCD-UI/dataset-uta10-annotations/blob/master/LICENSE)
[![Last commit](https://img.shields.io/github/last-commit/MIMBCD-UI/dataset-uta10-annotations?style=flat-square)](https://github.com/MIMBCD-UI/dataset-uta10-annotations/commits/master)
[![HitCount](http://hits.dwyl.io/MIMBCD-UI/dataset-uta10-annotations.svg)](http://hits.dwyl.io/MIMBCD-UI/dataset-uta10-annotations)
...
```bash
git clone https://github.com/MIMBCD-UI/dataset-uta10-annotations.git
```
...
Either as something that seems missing or any need for support, just open a [new issue](https://github.com/MIMBCD-UI/dataset-uta10-annotations/issues/new). Regardless of being a simple request or a fully-structured feature, we will do our best to understand them and, eventually, solve them.
...
- [`dataset-uta9-annotations`](https://github.com/MIMBCD-UI/dataset-uta9-annotations)
